<p>Attributes are pre-defined conditions that are used to indicate <a show='methods'>method</a> behaviors. These must be used as defined by their respective <a show='methods'>method</a>.</p>


<h3 style='color: #0F67A1;'>BIND ATTRIBUTES</h3>
<p>When the bind() <a show='methods'>method</a> is called with a <strong>type</strong> value of <em>"listen", "touch", "collide", "sit", or "unsit",</em> the following attributes may be used as a <strong>filter</strong> value. Additionally, for the <em>"collide"</em> <strong>type</strong>, you may set a name, object description, or key as the <strong>filter</strong> value.</p>

<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />all</p>
<span><p class='description'>This indicates that anyone can interact with this activity.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />owner</p>
<span><p class='description'>This indicates that only the object's owner can interact with this activity.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />notowner</p>
<span><p class='description'>This indicates that anyone besides the object's owner can interact with this activity.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />group</p>
<span><p class='description'>This indicates that only the object's group can interact with this activity.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />notgroup</p>
<span><p class='description'>This indicates that anyone besides the object's group can interact with this activity.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />faster</p>
<span><p class='description'>This indicates that only objects or avatars that are traveling faster than the eco-object can interact with this activity.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />slower</p>
<span><p class='description'>This indicates that only objects or avatars that are traveling slower than the eco-object can interact with this activity.</p></span>
</div>


<h3 style='color: #0F67A1;'>FILTER ATTRIBUTES</h3>
<p>The filter() <a show='methods'>method</a> determines the results of a pre-defined <strong>condition</strong>. You can compare any two values with a variety of operators, and you may also use the following attributes to determine if a <em>key</em> or <em>name</em> is associated with the breed object's group or owner.</p>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />group</p>
<span><p class='description'>This indicates that only the keys that are actively in the object's group will pass a TRUE result.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />owner</p>
<span><p class='description'>This indicates that only the object's owner will pass a TRUE result.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />notgroup</p>
<span><p class='description'>This indicates that only the keys that are NOT actively in the object's group will pass a TRUE result.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />notowner</p>
<span><p class='description'>This indicates that anyone besides the object's owner will pass a TRUE result.</p></span>
</div>


<h3 style='color: #0F67A1;'>MOVE ATTRIBUTES</h3>
<p>When the move() <a show='methods'>method</a> is called, the following attributes may be used to define movement behavior as the "type" value. The default "type" value is "setpos". These attributes can be further defined in the breed-object <a show='settings'>settings</a> script, such as: timer, speed, and distance.</p>

<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />float</p>
<span><p class='description'>Object displays incremental physical movement with behavior similar to a bird or other animal swimming on the surface of the water.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />fly</p>
<span><p class='description'>Object displays incremental physical movement with behavior similar to a bird or flying animal.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />hop</p>
<span><p class='description'>Object displays incremental physical movement with behavior similar to a hopping land animal.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />hover</p>
<span><p class='description'>Object displays incremental physical movement with behavior similar to a dragon fly or a slow flying/hovering animal.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />jump</p>
<span><p class='description'>Same behavior as "hop" but higher/faster.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />nonphys</p>
<span><p class='description'>Smooth nonphysical movement for primsets up to 256 prims.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />nonphysUp</p>
<span><p class='description'>Same behavior as "nonphys" but allows the breed to look at the destination vector along the z-axis.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />run</p>
<span><p class='description'>Same behavior as "walk" but faster.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />setpos</p>
<span><p class='description'>Object displays incremental non-physical movement. Best if within a 2 dimensional space (ie. not up or down hills). <span stye='color:orangered;'>This is the default move() type value if no type value is given.</span></p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />swim</p>
<span><p class='description'>Object displays incremental physical movement with behavior similar to a marine animal.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />walk</p>
<span><p class='description'>Object displays incremental physical movement with behavior similar to a land animal.</p></span>
</div>
<div class='expand entry'>
<p class='title'><img src='img/expand.gif' class='icon' />warp</p>
<span><p class='description'>Object displays non-physical movement immediately to the destination vector anywhere within a region.</p></span>
</div>


<h3 style='color: #0F67A1;'>VAL ATTRIBUTES</h3>
<p>When the val() <a show='methods'>method</a> is called, it requires one of the following <strong><a show='settings'>settings</a></strong>, unrecognized values will be ignored. These attributes are hard coded global settings which are otherwise inaccessible after creation. The val() method allows you to dynamically modify these settings during event flow. This is useful for creating traits that are earned which can affect the breed's <a show='core'>core</a> behavior.</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Breed_Litter_Min</p>
<span><p class='description'>This value sets the minimum number of breeds per of litter.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Breed_Litter_Max</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Breed_Litter_Rare</p>
<span><p class='description'>With this value enabled, larger litters become more rare than smaller litters.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Breed_Litters</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Consume_Min</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Consume_Max</p>
<span><p class='description'>This value indicates the maximum food units the breed will consume per hunger cycle, if available. This determines the range of the breed's appetite. The breed can only consume so much volume per hunger cycle, but the nutritional value can differ as determined by the individual food sources. As mentioned with Hunger_Consume_Min, if the food quality is too high for the amount needed by the breed, the food source will be ignored. The food's point value is determined by the food units multiplied by the food quality. So if the food quality is 10, one unit is worth 10 food points.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Death_Odds</p>
<span><p class='description'>This value defines the odds of death below the Hunger_Percent_Min threshold. If you set this value as '0' the breed will always die from hunger, if you set it to '-1' the bred will never die from hunger. The higher the odds value, the less likely the breed will die from hunger. When death occurs, the 'dead' event is raised and aging, breeding, hunger, and growth is haulted. Action classes, including prim animations and movement, will continue to run but can be disabled within the 'dead' event.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Percent_Min</p>
<span><p class='description'>If the hunger Hunger_Death_Odds have been set, this value defines the minimum hunger percentage threshold. If the threshold is breached and the odds result in favor of death, the object will trigger 'dead' event.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Consume_Odds</p>
<span><p class='description'>The odds of the breed skipping a meal. If a meal is skipped, the breed still suffers a hunger point reduction based on the Hunger_Percent_Lost setting. Set to '0' to always eat.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Consume_Time</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Hunger_Percent_Lost</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Growth_Stunted_Odds</p>
...
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Lifespan_Age_Min</p>
<span><p class='description'>This is the minimum age the breed must reach before possible death from 'old age'. After the breed reaches this age, it's survival is based on the Lifespan_Survival_Odds. Once the breed reaches it's maximum age, if defined, the breed will immediately die.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Lifespan_Age_Max</p>
<span><p class='description'>This is the maximum age the breed can reach before death from 'old age'. After the breed reaches this age, it's survival is no longer based on the Lifespan_Survival_Odds, the breed will immediately die which causes hunger, aging, breeding, and growth to stop. Action methods including movement and prim animations will continue unless stopped within the native 'dead' event. This value can be set to '-1' to allow it to continue aging indefinitely.</p></span>
</div>
<div class='expand entry'>
<p class='tags'>integer</p><p class='title'><img src='img/expand.gif' class='icon' />Lifespan_Survival_Odds</p>
...
<div class='expand entry'>
<p class='tags'>float</p><p class='title'><img src='img/expand.gif' class='icon' />Turning_Efficiency</p>
...
<span><p class='description'>breed object's family name (set using the <a show='api'>API</a> or the <a show='myaccount'>My Account</a> page)</p></span>
</div>
<div class='expand entry'>
<p class='tags'>string</p><p class='title'><img src='img/expand.gif' class='icon' />MyName</p>
<span><p class='description'>breed object's name (set using the <a show='settings'>Name_Generator</a> or by using the <a show='api'>API</a> or the <a show='myaccount'>My Account</a> page)</p></span>
</div>
<div class='expand entry'>
